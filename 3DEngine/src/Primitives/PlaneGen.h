...
{
public:
	static IndexedTriangleList MakeTesselatedTextured(D3D11::VertexLayout layout, int divisions_x, int divisions_y)
	{
		...
		indices.reserve(Math::sqPow(divisions_x * divisions_y) * 6);
		{
